    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col items-center justify-center mb-4">
            ...
            <span className="text-sm text-gray-500 mt-2">
              Based on 94 Ratings on JustDial
            </span>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          <a
            href="https://www.justdial.com/Nagpur/QuickFusion-Innovations-Kachi-Visa-Oswal-Ground-Chapru-Nagar/0712PX712-X712-240814121154-W3C5_BZDET"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold rounded-xl text-white bg-[#49af2f] hover:bg-[#3d8f26] hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
